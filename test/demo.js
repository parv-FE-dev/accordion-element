...
<div style={{width:"100%", height:"100%"}}>
  <HorizontalAccordion className='horizontal-accordion'>
    <AccordionItem>
      <AccordionButton className='accordion-button'>L<br/>o<br/>r<br/>e<br/>m<br/></AccordionButton>
    ...
    <AccordionItem defaultOpen="true">
      <AccordionButton className='accordion-button'>I<br/>p<br/>s<br/>u<br/>m</AccordionButton>
